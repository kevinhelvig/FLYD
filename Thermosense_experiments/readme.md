...
- __[2024/10/21]__ : Weights and datasets added 🔥
- __[2024/10/10]__ : Folder created. Adding the different links and explanations is on the way ! :biking_man:

# Stable Diffusion: Weights and minimal script usage 🏋️🖌️

<figure>
<p align="center">
<img src="Illustrations_thermosense/illustration_synthesis_Thermosense.png" alt="Alt Text 1" style="width:100%; height:auto;"></p>
<figcaption style="text-align: center; font-style: italic;"> <p> <i> Examples of synthetic images generated by each diffuser trained for this experiment. Remember this synthesis is only statistically guided, and may not reflect properly the physics of Flying-Spot thermography.  </i> </p> </figcaption>
</figure>
...
* Link to the negative generator's weights 🏋️‍♂️ : [[Zenodo](https://zenodo.org/records/13912234/files/negative_generator.zip?download=1)] <br>
* Link to the positive generator's weights 🏋️‍♀️: [[Zenodo](https://zenodo.org/records/13912234/files/positive_generator.zip?download=1)] <br> 
...
We provide links to download the corresponding thermal images [[Classes](https://zenodo.org/records/13912234/files/flyd_frames_classification.zip?download=1)] [[YOLO](https://zenodo.org/records/13912234/files/FLYD_Frames_YOLO_format.zip?download=1)]] 
